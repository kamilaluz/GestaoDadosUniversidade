        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumeroContrato = table.Column<int>(type: "integer", nullable: true),
                    Periodicidade = table.Column<int>(type: "integer", nullable: true),
                    ValorServico = table.Column<double>(type: "double precision", nullable: true),
                    DataPagamento = table.Column<DateOnly>(type: "date", nullable: true),
                    VencimentoContrato = table.Column<DateOnly>(type: "date", nullable: true)
                },
                constraints: table =>
                {
